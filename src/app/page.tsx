...
const handoffJournalHighlights = [
  "Multiple shift entries with summaries, highlights, and explicit action bullets",
  "Compact carry-forward notes that keep unresolved items visible for the next crew",
  "Responsive journal layout tuned for quick reads on floor tablets and desktop stations",
];
      ...
      <section className="overflow-hidden rounded-[2rem] border border-[var(--line)] bg-[var(--surface)] shadow-[0_20px_90px_rgba(15,23,42,0.06)]">
        <div className="grid gap-8 px-6 py-8 sm:px-10 lg:grid-cols-[minmax(0,1fr)_minmax(260px,0.9fr)] lg:px-12 lg:py-10">
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              <h2 className="max-w-2xl text-3xl font-semibold tracking-tight text-slate-950 sm:text-4xl">
                Open the handoff journal for shift summaries, action bullets,
                and carry-forward notes.
              </h2>
              <p className="max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
                The handoff journal stages a standalone operational log with
                multiple shift entries, compact next-step bullets, and a short
                carry-forward rail so incoming crews can scan what remains
                unresolved without reopening active issue boards.
              </p>
            </div>
            <div className="flex flex-col gap-4 sm:flex-row">
              <Link
              ...
              <a
                href="https://github.com/iamasx/api-test/issues/174"
                className="inline-flex items-center justify-center rounded-full border border-slate-300 px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-950 hover:text-slate-950"
                target="_blank"
                rel="noreferrer"
              >
